...
check("RC5.3 activates only the MOMO A13 executable ratchet", [
  DAY1_EXECUTABLE_GIVEBACK_TRAILS,
...
], ["day1_spy_same_clock_collision", "weekend-day1-2026-07-21-rc5.3", DAY1_RELEASE_CONFIGURATION_SHA256,
...
], [WORKER_VERSION, "weekend-day1-2026-07-21-rc5.3", DAY1_RELEASE_CONFIGURATION_SHA256,
...
const hotfixReceipt = JSON.parse(readFileSync(
  new URL("../../docs/weekend-day1-rc5-3-operational-hotfix-2026-07-20.json", import.meta.url),
  "utf8",
)) as {
