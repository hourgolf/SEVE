...
export const WORKER_VERSION = "stream-2026-07-13a"; // Phase 1G durable post-close manager shadow book (dark/observation-only; env-gated). Prior (07-12g): root-visible worker deps for the post-close day-report child. Prior (07-12f): dark counterfactual manager exits on the executable-bid sweep. Deferred: #12/#14 (broker samples), #17 (spread-capture dormant), #18 (per-strike chain staleness).
