...
export function buildShadowPlanEvidence(input: ShadowPlanInput): ShadowPlanEvidence | null {
  ...
  const planId = deterministicUuid("seve-position-plan-v1", opportunityId);
