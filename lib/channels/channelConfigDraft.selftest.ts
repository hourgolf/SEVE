...
const model = (patch: Parameters<typeof deriveChannelConfigDraft>[0]["patch"], releaseState: Parameters<typeof deriveChannelConfigDraft>[0]["releaseState"] = "verified") => deriveChannelConfigDraft({
  ...
  patch,
  releaseState,
  releaseId: "weekend-day1-2026-07-20-rc5",
...
check("canonical content contains release identity", () => assert.match(model({ entry_dte: 1 }).canonicalJson, /weekend-day1-2026-07-20-rc5/));
