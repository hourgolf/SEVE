...
import { resolveChannelRuntimeAuthority, summarizeChannelRuntimeRoster } from "./channelRuntimeAuthority";

const view = {
  state: "receipt-bound",
  specs: [
    { slug: "live", executionPosture: "paper", accountId: "paper-2", accountLabel: "PAPER 2", quantity: 3 },
    { slug: "watch", executionPosture: "observe-only", accountId: "paper-2", accountLabel: "PAPER 2", quantity: 1 },
  ],
  bySlug: {
...
assert.deepEqual(summarizeChannelRuntimeRoster(view), {
  state: "receipt-bound",
  paper: 1,
  observing: 1,
  accounts: 1,
