  ...
  return (
    <div className="perform" data-incident={incident.severity} data-focus={focus} data-section={section}>
      ...
      <main className="pf-stage">
        ...
        {section === "market" ? <PerformMarketsWorkspace surface={surface} destination={destination} onNavigate={onNavigate} /> : section === "positions" ? <PerformPositionsWorkspace surface={surface} onNavigate={onNavigate} /> : section === "research" ? <ShadowResearchWorkspace surface={surface} destination={destination} onNavigate={onNavigate} /> : section === "sentinel" ? <SentinelWorkspace sentinel={sentinel} symbol={symbol} activeConfigurationHash={surface.channelWorkspace.release.state === "verified" ? surface.channelWorkspace.release.expectedHash : null} /> : section === "tape" ? <ReviewWorkspace surface={surface} destination={destination} onNavigate={onNavigate} /> : section === "ops" ? <OpsWorkspace surface={surface} destination={destination} onNavigate={onNavigate} /> : onNavigate ? <DecisionHomeWorkspace surface={surface} onNavigate={onNavigate} /> : <>
