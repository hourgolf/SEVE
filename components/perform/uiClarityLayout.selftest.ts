...
assert.match(reviewScorecard, /SAMPLED HELD PEAK/);
assert.match(reviewScorecard, /HELD-MARK RATIO/);
...
assert.match(research, /REFERENCE POLICY/);
assert.match(fixture, /FAVORABLE PEAKS · WEAK FINISH/);
assert.match(fixture, /POSITIVE PATH RESULTS/);
