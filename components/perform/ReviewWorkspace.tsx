  ...
  return (
    <section className="rvw" id="perform-tape" tabIndex={-1} aria-label="Review workspace">
      ...
      <div className="rvw-body" role="tabpanel" data-review-section={section}>
        ...
        {section === "performance" && (
          <>
            {latestCompletedSession && <div className="rvw-results-anchor"><b>LAST COMPLETED SESSION · {latestCompletedSession}</b><span>Account Results opens to the trailing 7 days. Choose Today only for the live session.</span></div>}
            <PnlPanel
              strategists={view.desk.strategists}
