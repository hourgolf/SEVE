...
export function FolioBookMobile({ surface, onViewChart }: { surface: SurfaceProps; onViewChart: () => void }) {
  return <div className="folio-book folio-book-mobile"><MobileBookView props={surface} onViewChart={onViewChart} /></div>;
}
